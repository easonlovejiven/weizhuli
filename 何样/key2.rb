def aaa(keywords,filename,opts,&block) #start_time:开始时间,end_time：结束时间，filename:导出文件名，keywords:关键词数组
      ...
      filter_max_fans = opts[:filter_max_fans] #微薄粉丝量控制0.3.11
            ...
            keywords.each do|keyword|
              ...
              number = 0
                ...
                while (processing == true) do
                  pas={access_token:"2.002F_9jFDtpNAD8e2fe8ebba0LNZaN",q:q,endtime:endtime,count:50,antispam:0,dup:0} #定义一个hash 用来存参数用 to_query 方法追加
